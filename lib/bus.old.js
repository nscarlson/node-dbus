...
var Interface = require('./interface.new')
...
Bus.prototype.introspect = function (serviceName, objectPath, callback) {
    ...
    self.callMethod(
        ...
        function (err, introspect) {
            ...
            if (!obj) {
                if (callback) callback(new Error('No introspectable'))
...
Bus.prototype.getInterface = function (
    serviceName,
    objectPath,
    interfaceName,
    callback,
    ...
    self.introspect(serviceName, objectPath, function (err, obj) {
        ...
        if (!(interfaceName in obj)) {
            if (callback) callback(new Error('No such interface'))
...
Bus.prototype.registerSignalHandler = function (
    serviceName,
    objectPath,
    interfaceName,
    interfaceObj,
...
Bus.prototype.addSignalFilter = function (
    sender,
    objectPath,
    interfaceName,
    callback,
