...
LIBS := \
	-L/opt/homebrew/Cellar/dbus/1.14.10/lib \
	-ldbus-1

$(builddir)/dbus.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/dbus.node: LIBS := $(LIBS)
$(builddir)/dbus.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/dbus.node: TOOLSET := $(TOOLSET)
$(builddir)/dbus.node: $(OBJS) $(builddir)/libexpat.a FORCE_DO_CMD
